							...
							<div class="row">
								<form role="form" action="MinhChungServlet" method="post">
									<div class="col-lg-6">
										...
										<div class="form-group">
											<label>Chọn bộ tiêu chuẩn</label> <select id="BoTieuChuan"
												...
												<option selected disabled hidden="hidden" style="display: none"
													value=""></option>
												<%
											...
											<label>Chọn nơi ban hành</label> <select name="IDNoiBanHanh"
												...
												<%
													for (NoiBanHanh noiBanHanh : noiBanHanhDAO.getListNoiBanHanh()) {
														out.println("<option value=\"" + noiBanHanh.getID() + "\">" + noiBanHanh.getTenNoiBanHanh()
																+ "</option>");
													}
												%>
											</select>
									...
									<div class="col-lg-6">
										...
										<div class="form-group">
											<label>Chọn file</label> <input type="file">
										</div>
